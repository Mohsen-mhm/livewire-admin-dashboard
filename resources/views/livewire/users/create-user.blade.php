        ...
        <div class="relative w-full h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form class="w-full flex flex-col justify-center items-center" wire:submit.prevent="store"
                        ...
                        <button type="submit"
                            ...
                            <span class="mx-auto" wire:target="store" wire:loading.remove>Create user</span>
